...
<div class="row justify-content-center">
    <div class="col-lg-10">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p class="text-justify" > This survey evaluates your readiness to engage in e-learning activities effectively and efficiently. Your responses to the survey will be used to identify areas where you may need additional support or resources to enhance your e-learning experience. Thank you for your participation!</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card shadow mb-4 score-card">
                ...
                <div class="card-body">
                    <div class="score-value">{{auth()->user()->final_score }}</div>
