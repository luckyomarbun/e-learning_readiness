            ...
            <div class="card-body">
                ...
                <div class="text-center survey-button">
                    ...
                    <form action="{{ route('dashboard') }}" method="POST">
                        @csrf
                        <button type="submit" name="take_survey" value="1" class="btn btn-primary btn-lg">Take Survey</button>
                    </form>
                    <!-- <a href="{{ route('dashboard', ['take_survey' => 1]) }}" class="btn btn-primary btn-lg">Take Survey</a> -->
                </div>
            </div>
        </div>
    </div>
