                ...
                <main class="form-master">
                    <form action="{{ route('criteria.update', $criteria->id) }}" method="post">
                        ...
                        <div class="form">
                            ...
                            <input type="text" name="name" class="form-control rounded-top  @error('name') is-invalid @enderror" id="name" placeholder="Nama Kriteria" required value="{{ old('name', $criteria->name) }}">
                            @error('name')
